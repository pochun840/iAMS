...
$text['Reverse_Button_text'] = 'Rev. Button(CCW/Disable)';
...
$text['Batch_Mode_text'] = 'Counting Method';
...
$text['Task_Reset_Button_Access_text'] = 'Reset Task';
$text['Job_Selection_Access_text'] = 'Call Job';
$text['Seq_Selection_Access_text'] = 'Call Sequence';
$text['Stop_On_NG_text'] = 'NG Stop Reset';
...
$error_message['Hi_Torque'] = 'Out of range must be greater than Target Torque and less than Tool Max Torque';
$error_message['Low_Torque'] = 'Out of range must be less than Target Torque';
$error_message['Threshold_Torque'] = 'Out of range must be less than Target Torque';
$error_message['Target_Torque'] = 'Out of range must be greater than Tool Min Torque and less than Tool Max Torque';
$error_message['Joint_OffSet'] = '<br>Out of range must be less than Target Torque';
$error_message['Run_Down_Speed'] = 'Out of range 60 - 1100';
$error_message['Downshift_Torque'] = 'Out of range, must be greater than Threshold Torque and less than Target Torque';
$error_message['Downshift_Speed'] = 'Out of range 60 - Run Down Speed';
$error_message['High_Angle'] = 'Out of range 1 - 30600';
$error_message['Low_Angle'] = 'Out of range 0 - 30599';
...
if(isset($data['tool_info'])){
$error_message['Hi_Torque'] = 'Must be greater than Target_Torque and less than'.$data['tool_info']['tool_maxtorque'];
$error_message['Low_Torque'] = 'Need to be less than '.$data['tool_info']['tool_maxtorque'].' or less than High Torque';
...
//advanced step
$error_message['step_name'] = 'The step name input is wrong';
...
if(isset($data['tool_info'])){
	$error_message['Pre_Run_RPM'] = 'Out of range'.$data['tool_info']['tool_minrpm'].' - '.$data['tool_info']['tool_maxrpm'];
	$error_message['Torque_Window_Add'] = 'Out of range '.$data['tool_info']['tool_mintorque'].' - '.$data['tool_info']['tool_maxtorque'];;
}
