...
$text['Reverse_Button_text'] = '拆螺丝设定';
$text['Reverse_RPM_text'] = '拆螺丝转速';
$text['Reverse_Force_text'] = '拆螺丝力道（%）';
...
$text['Copy_from_text'] = '匹配自';
$text['Copy_to_text'] = '匹配至';
...
//----------------------------------------------------------------------------------------------------------------
//圖表單位
$text['Torque/Time(MS)'] = '扭矩/时间';
$text['Angle/Time(MS)'] = '角度/时间';
$text['RPM/Time(MS)'] = '转速/时间';
$text['Power/Time(MS)'] = '功率/时间';
$text['Torque/Angle'] = '扭矩/角度';
$text['Torque&Angle/Time(MS)'] = '扭矩&角度/时间';
