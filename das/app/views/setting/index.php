    ...
    <div class="main-content ">
        <div class="center-content">
            <div class="w3-center col-ms-3 pt-2">
                ...
                <button id="bnt4" name="Connect_Display" class="button button3" onclick="OpenButton('Connect')" <?php if($_SESSION['privilege'] != 'admin'){echo "style=\"display:none\" ";} ?>>Connect Setting</button>
