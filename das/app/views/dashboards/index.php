    ...
    <div class="main-content">
        <div class="center-content w3-center">
            <div style="position: relative;text-shadow:3px 5px 0 #444;" class="wrapper w3-center w3-text-red">
                ...
                <h1 class="col-ms-3 pt-5" style="font-size: 50px;">KILEWS</h1>
                <div style="text-shadow:2px 2px 0 #444; font-size: 30px" class="text w3-center w3-text-yellow">iDAS FOR GTCS</div>
            </div>
